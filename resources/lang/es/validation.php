...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            'between' => 'El campo :attribute debe contener al menos :min y un máximo de :max caracteres.',
        ],
        ...
        'email' => [
            'max' => 'El campo :attribute solo puede contener un máximo de :max caracteres.',
        ],
        'email' => [
            'unique' => 'El :attribute ya esta en uso.',
        ],
        'email' => [
            'email' => 'El :attribute no tiene la estructura adecuada (alguien@carvajal.com).',
        ],
        ...
        'password' => [
            'confirmed' => 'Las contraseñas No coincide. Recuerda que deben ser iguales.',
        ],
        'password' => [
            'regex' => 'La :attribute debe contener al menos una letra mayuscula (A-Z), una letra minuscula (a-z), un número (0-9) y por lo menos uno de los siguientes caracteres especiales:  # ´ ` ? ! @ $ % ^ : & * ~ -',
        ]
    ],
